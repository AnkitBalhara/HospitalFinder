      ...
      <div className="relative flex w-full lg:w-1/2 h-auto lg:h-[90vh] shadow-lg rounded-2xl bg-white p-5 sm:p-10 flex-col justify-center text-center lg:text-left">
        ...
        <div className="mt-6 space-y-4">
          <div className="flex items-center justify-center lg:justify-start space-x-3">
            ...
            <p className="text-gray-700 text-base sm:text-lg">Find the nearest hospitals instantly</p>
          </div>
          <div className="flex items-center justify-center lg:justify-start space-x-3">
            <span className="text-blue-500 text-2xl">✔️</span>
            <p className="text-gray-700 text-base sm:text-lg">Book doctor appointments online</p>
          </div>
          <div className="flex items-center justify-center lg:justify-start space-x-3">
            <span className="text-blue-500 text-2xl">✔️</span>
            <p className="text-gray-700 text-base sm:text-lg">Get emergency medical assistance</p>
          </div>
        </div>
